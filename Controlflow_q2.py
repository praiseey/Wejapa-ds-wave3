...
### For Question 2: Please provide a list with the name(s) of the director(s)
# with the most Oscar wins. The list can hold the names of multiple directors,
...
for key in winners:
    value = winners[key]
    win_director.extend(value)

print(win_director)
most_win_director = max(win_director, key=win_director.count)
